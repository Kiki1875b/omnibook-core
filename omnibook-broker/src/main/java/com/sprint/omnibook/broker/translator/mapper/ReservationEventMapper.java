...
public interface ReservationEventMapper {
    ...
    @Mapping(source = "payload.accommodationName", target = "propertyId")
    ...
    @Mapping(source = "payload.hostId", target = "propertyId")
    ...
    @Mapping(source = "payload.accommodationId", target = "propertyId")
